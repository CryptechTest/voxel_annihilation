...
va_commands.register_command("capture", {
    description = "Capture",
    range = 128,
    execute_primary = function(itemstack, user, pointed_thing)
        ...
        core.chat_send_player(player_name, "Immediate capture command.")
    end,
    execute_secondary = function(itemstack, user, pointed_thing)
        ...
        core.chat_send_player(player_name, "Queued capture command.")
    end,
})
