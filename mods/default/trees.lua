...
local function add_pine_needles(data, vi, c_air, c_ignore, c_pine_needles)
	local node_id = data[vi]
...
function default.grow_pine_tree(pos)
	...
	-- Centre top nodes
	add_pine_needles(data, a:index(x, maxy + 1, z), c_air, c_ignore, c_pine_needles)
	add_pine_needles(data, a:index(x, maxy + 2, z), c_air, c_ignore, c_pine_needles) -- Paramat added a pointy top node
